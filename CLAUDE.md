...
счётчика на `84983065`, которая лежала незакоммиченной в рабочей копии. Четыре дня весь
сайт писался в чужой счётчик, в `52399276` капал только лендинг. Перенести визиты между
счётчиками Метрика не умеет — данные за этот период потеряны безвозвратно.
